...
export const services = [
  {
    ...
    iconBg: `<svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
    ...
    iconLogo: `bxl-dribbble`,
    description:
      "Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi",
  },
  {
    title: "Sed Perspiciatis",
    iconBox: "iconbox-orange",
    iconBg: ` <svg
                      width="100"
                      height="100"
                      viewBox="0 0 600 600"
  ...
  },
  {
    ...
    iconLogo: `bx-tachometer`,
    description:
      "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia",
  },
  {
    title: "Nemo Enim",
    iconBox: "iconbox-yellow",
    iconBg: `<svg
                      width="100"
                      height="100"
                      viewBox="0 0 600 600"
