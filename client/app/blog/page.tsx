        ...
        <div className="container">
          <div className="row">
            {token ? (
                  ...
                  <article className="entry">
                    ...
                    <h2 className="entry-title">
                      <a href="blog-single.html">
                        ...
                        deleniti explicabo eius exercitationem. Veniam eius
                        velit ab ipsa quidem rem.
                      </a>
                    </h2>
              ...
              <p>Please Signin to Check out out latest blogs</p>
            )}
          </div>
        </div>
      </section>
